 ...
 */
function bears_taxonomy_settings_field($settings, $value) {
...
bears_add_extra_parame('bt_taxonomy', 'bears_taxonomy_settings_field', get_template_directory_uri().'/assets/vc_extend/vc_taxonomy.js');

/*
 * Layout select list field
 */
function bears_layout_settings_field($settings, $value) {
    $dependency = function_exists('vc_generate_dependencies_attributes') ? vc_generate_dependencies_attributes($settings) : '';
...
bears_add_extra_parame('bt_layout', 'bears_layout_settings_field', get_template_directory_uri().'/assets/vc_extend/vc_layout.js');
