<?php
function bears_register_layout_category( $categories ) {
...
add_filter( 'block_categories_all', 'bears_register_layout_category' );

function bears_acf_init() {

    // check function exists
    if( function_exists('acf_register_block') ) {
        acf_register_block(array(
            'name'              => 'widget-recent-posts',
            'title'             => __('Widget - Recent Posts', 'bears'),
            'description'       => __('Widget - Recent Posts block.', 'bears'),
            'render_callback'   => 'bears_acf_block_render_callback',
            // 'enqueue_assets' => 'bears_acf_block_assets_callback',
            ...
            'title'             => __('Widget - Contact Information', 'bears'),
            'description'       => __('Widget - Contact Information block.', 'bears'),
            'render_callback'   => 'bears_acf_block_render_callback',
            // 'enqueue_assets' => 'bears_acf_block_assets_callback',
            'category'          => 'bt-custom-block',
            'icon'              => '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M19 13H5v-2h14v2z" /></svg>',
            ...
            'title'             => __('Widget - Instagram Posts', 'bears'),
            'description'       => __('Widget - Instagram Posts block.', 'bears'),
            'render_callback'   => 'bears_acf_block_render_callback',
            // 'enqueue_assets' => 'bears_acf_block_assets_callback',
            'category'          => 'bt-custom-block',
            'icon'              => '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z" /><path d="M19 13H5v-2h14v2z" /></svg>',
...
add_action('acf/init', 'bears_acf_init');

function bears_acf_block_render_callback( $block ) {
...
function bears_acf_block_assets_callback($block) {
