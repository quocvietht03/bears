...
vc_map(array(
	'name' => esc_html__('Fancy Box', 'bears'),
	'base' => 'bt_fancy_box',
	...
	'params' => array(
		...
		array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Content Space', 'bears'),
			...
			'description' => esc_html__('Please, enter number with px space between content and icon in this element. Ex: 60px', 'bears')
		),
		...
		array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Icon Style', 'bears'),
			...
			'group' => esc_html__('Icon', 'bears'),
			'description' => esc_html__('Select style icon in this elment.', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Icon Size', 'bears'),
			...
			'description' => esc_html__('Please, enter number size icon in this element. Ex: 60px', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
		...
		array(
			...
			'description' => esc_html__('Select border style icon in this elment.', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'description' => esc_html__('Please, enter number with px border width icon in this element. Ex: 2px', 'bears')
		),
		array(
			'type' => 'colorpicker',
			'class' => '',
			...
			'description' => esc_html__('Select border color icon in this element.', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Space', 'bears'),
			'param_name' => 'icon_space',
			'value' => '',
			'group' => esc_html__('Icon', 'bears'),
			'description' => esc_html__('Please, enter number with px space between icon and content in this element. Ex: 30px', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
		...
		array(
			...
			'group' => esc_html__('Title', 'bears'),
			'description' => esc_html__( 'Add custom link of the title in this element.', 'bears' )
		),
		array(
			'type' => 'textfield',
			'class' => '',
		...
		array(
			...
			'value' => '',
			'group' => esc_html__('Title', 'bears'),
			'description' => esc_html__('Please, enter number with px space between title and description in this element. Ex: 15px', 'bears')
		),
		array(
			'type' => 'textarea_html',
			'class' => '',
			'heading' => esc_html__('Description', 'bears'),
			'param_name' => 'content',
			'value' => '',
			'group' => esc_html__('Description', 'bears'),
			'description' => esc_html__('Please, enter description in this element.', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Description', 'bears'),
			'description' => esc_html__('Please, enter number  with px font size description in this element. Ex: 14px', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Description', 'bears'),
			'description' => esc_html__('Please, enter number with px line height description in this element. Ex: 24px', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Description', 'bears'),
			'description' => esc_html__('Please, enter number with px letter spacing description in this element. Ex: 1px', 'bears')
		),
		array(
			'type' => 'colorpicker',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Description', 'bears'),
			'description' => esc_html__('Select color description in this element.', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Description', 'bears'),
			'description' => esc_html__('Please, enter number with px space between description and read more in this element. Ex: 15px', 'bears')
		),
		array(
			'type' => 'vc_link',
			'heading' => esc_html__( 'URL (Link)', 'bears' ),
			'param_name' => 'link',
			'group' => esc_html__('Extra Link', 'bears'),
			'description' => esc_html__( 'Add extra link in this element.', 'bears' )
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'bears'),
			'description' => esc_html__('Please, enter number  with px font size extra link in this element. Ex: 14px', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'bears'),
			'description' => esc_html__('Please, enter number with px line height extra link in this element. Ex: 24px', 'bears')
		),
		array(
			'type' => 'textfield',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'bears'),
			'description' => esc_html__('Please, enter number with px letter spacing extra link in this element. Ex: 1px', 'bears')
		),
		array(
			'type' => 'colorpicker',
			'class' => '',
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'bears'),
			'description' => esc_html__('Select color extra link in this element.', 'bears')
		),
		array(
			'type' => 'css_editor',
