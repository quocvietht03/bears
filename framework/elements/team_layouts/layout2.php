...
<div class="bt-item">
		...
		<div class="bt-overlay">
			<div class="bt-info">
				<?php
					...
					if($email) echo '<div class="bt-email"><a href="mailto:'.esc_attr($email).'"><i class="fa fa-paper-plane-o"></i> '.$email.'</a></div>';
			
					if($phone) echo '<div class="bt-phone"><a href="tel:'.esc_attr($phone).'"><i class="fa fa-phone"></i> '.$phone.'</a></div>';
	...
	<div class="bt-content">
		...
		<?php if($positon) echo '<h4 class="bt-position">'.$positon.'</h4>'; ?>
	</div>
</div>
