...
vc_map(array(
	'name' => esc_html__('Team Grid', 'bears'),
	'base' => 'bt_team_grid',
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				...
				'2 Columns' => 'col-lg-6',
				'1 Column' => 'col-lg-12',
				'5 Columns(Custom)' => 'bt-col-lg-5',
				'6 Columns(Extra)' => 'col-lg-2'
			),
		...
		array(
			'type' => 'textfield',
			'heading' => esc_html__( 'Post IDs', 'bears' ),
			'param_name' => 'post_ids',
			'group' => esc_html__('Data Setting', 'bears'),
			'description' => esc_html__( 'Enter post IDs to be excluded (Note: separate values by commas (,)).', 'bears' ),
		),
		array (
			'type' => 'textfield',
		...
		array(
			...
			'value' => 'thumbnail',
			'group' => esc_html__('Item Setting', 'bears'),
			'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "thumbnail" size.', 'bears' ),
		),
		array(
			'type' => 'textfield',
			'class' => '',
