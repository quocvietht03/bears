<?php
class bears_Icon_Info_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'icon_info_widget', // Base ID
                esc_html__('Icon Info', 'bears'), // Name
                array('description' => esc_html__('Icon Info Widget', 'bears'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('font_icon')); ?>"><?php _e('Icon:', 'bears');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('meta_info')); ?>"><?php _e('Text:', 'bears');
		 ?></label>
 ...
 */
function bears_register_icon_info_widget() {
    register_widget('bears_Icon_Info_Widget');
}
add_action('widgets_init', 'bears_register_icon_info_widget');
?>
