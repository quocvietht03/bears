<?php
namespace BearsElementorWidgets\Widgets\StepList;
...
class Widget_StepList extends Widget_Base {
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			'list',
			[
				'label' => __( 'List Step', 'bears' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'bears' ),
						'step_title' => __( 'This is step title 01', 'bears' ),
						'step_desc' => __( 'This is description', 'bears' ),
						'step_btn_text' => __( 'Read More', 'bears' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'bears' ),
						'step_title' => __( 'This is step title 02', 'bears' ),
						'step_desc' => __( 'This is description', 'bears' ),
						'step_btn_text' => __( 'Read More', 'bears' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'bears' ),
						'step_title' => __( 'This is step title 03', 'bears' ),
						'step_desc' => __( 'This is description', 'bears' ),
						'step_btn_text' => __( 'Read More', 'bears' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'bears' ),
						'step_title' => __( 'This is step title 04', 'bears' ),
						'step_desc' => __( 'This is description', 'bears' ),
						'step_btn_text' => __( 'Read More', 'bears' ),
						'step_btn_link' => '#'
					],
					[
						'step_image' => Utils::get_placeholder_image_src(),
						'step_subtitle' => __( 'Sub title', 'bears' ),
						'step_title' => __( 'This is step title 05', 'bears' ),
						'step_desc' => __( 'This is description', 'bears' ),
						'step_btn_text' => __( 'Read More', 'bears' ),
						'step_btn_link' => '#'
					],
		...
		$this->add_control(
			'show_more_button',
			[
				'label' => __( 'Show More Button', 'bears' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show More Text', 'bears' ),
				'type' => Controls_Manager::TEXT,
				'show_label' => true,
				'default' => __( 'More Steps', 'bears' ),
				'condition' => [
					'show_more_button!' => '',
				],
			]
    ...
    $this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Show More Button', 'bears' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_more_button!' => '',
				],
