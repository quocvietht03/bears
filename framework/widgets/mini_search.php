...
class bears_Widget_Mini_Search extends WP_Widget {
	
	function __construct() {
		parent::__construct(
			'bt_widget_mini_search', // Base ID
			__('Mini Search', 'bears'), // Name
			array('description' => esc_html__('Display the mini search in the menu right sidebar.', 'bears'),) // Args
        );
    ...
    function form($instance) {
		...
		?>
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'bears'); ?></label>
...
/**
 * Class bears_Widget_Mini_Search
 */
function register_bears_widget_mini_search() {
    register_widget('bears_Widget_Mini_Search');
}
add_action('widgets_init', 'register_bears_widget_mini_search');
