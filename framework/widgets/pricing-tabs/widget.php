<?php
namespace BearsElementorWidgets\Widgets\PricingTabs;
  ...
  public function get_icon() {
	...
	protected function register_style_section_controls() {
		...
		$this->start_controls_section(
			'section_style_nav',
			[
				'label' => esc_html__( 'Navigation', 'bears' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
              ...
              <div class="bt-pricing-tabs">
								...
								<div class="bt-pricing-tabs--panels">
									<?php $counter = 0; while ( $query->have_posts() ) : $query->the_post(); $counter++;
												...
												$featured_text = get_field('featured_text') ? get_field('featured_text') : __( 'Featured', 'bears' );
