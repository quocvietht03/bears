<?php
namespace BearsElementorWidgets\Widgets\PageBreadcrumb;
...
class Widget_PageBreadcrumb extends Widget_Base {
	...
	public function get_title() {
		return __( 'Page Breadcrumb', 'bears' );
	}
	...
	protected function register_style_content_section_controls() {
		...
		$this->add_control(
			'text_color_hover',
			[
				'label' => __( 'Text Color Hover', 'bears' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-page-breadcrumb' => 'color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Text Typography', 'bears' ),
				'default' => '',
