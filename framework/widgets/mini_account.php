<?php
class bears_Mini_Account_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'mini_account_widget', // Base ID
                __('Mini Account', 'bears'), // Name
                array('description' => __('Mini Account Widget', 'bears'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('login_text')); ?>"><?php _e('Login Text:', 'bears');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('logout_text')); ?>"><?php _e('Logout Text:', 'bears');
		 ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('cl_class')); ?>"><?php _e('Extra Class:', 'bears'); ?></label>
...
/**
 * Class bears_Mini_Acount_Widget
 */
function bears_register_mini_account_widget() {
    register_widget('bears_Mini_Account_Widget');
}
add_action('widgets_init', 'bears_register_mini_account_widget');
?>
