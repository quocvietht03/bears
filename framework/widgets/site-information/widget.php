<?php
namespace BearsElementorWidgets\Widgets\SiteInformation;
...
class Widget_SiteInformation extends Widget_Base {
	...
	public function get_title() {
		return __( 'Site Information', 'bears' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__( 'Show Elements', 'bears' ),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'options' => [
					'phone'  => esc_html__( 'Phone', 'bears' ),
					'email' => esc_html__( 'Email', 'bears' ),
					'address' => esc_html__( 'Address', 'bears' ),
				],
				'default' => [ 'phone', 'email' ],
			]
		);
	...
	protected function register_layout_section_controls() {
		...
		$this->add_control(
			'style',
			[
				'label' => esc_html__( 'Layout Style', 'bears' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'column' => [
						'title' => esc_html__( 'Block', 'bears' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'row' => [
						'title' => esc_html__( 'Inline', 'bears' ),
