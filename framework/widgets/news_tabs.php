<?php
class bears_New_Tabs_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'bears_news_tabs_widget', // Base ID
                esc_html__('News Tabs', 'bears'), // Name
                array('description' => esc_html__('News Tabs Widget', 'bears'),) // Args
        );
    }
        ...
        <div class="tab-holder">
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs">
					<li class="active bt-tab" ><a href="#tab1" data-toggle="tab" ><?php esc_html_e('Recent Post', 'bears'); ?></a></li>
					<li class="bt-tab"><a href="#tab2" data-toggle="tab" ><?php esc_html_e('Popular Post', 'bears'); ?></a></li>
                </ul>
									...
									<li>
										...
										<div class="bt-details">
											<div class="bt-inner">
												...
												<ul class="bt-meta">
													<li class="bt-author"><?php echo esc_html__('By ', 'bears').get_the_author(); ?></li>
...
/**
 * Class bears_New_Tabs_Widget
 */
function register_new_tabs_widget() {
    register_widget('bears_New_Tabs_Widget');
}
