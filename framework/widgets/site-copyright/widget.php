<?php
namespace BearsElementorWidgets\Widgets\SiteCopyright;
...
class Widget_SiteCopyright extends Widget_Base {
	...
	public function get_title() {
		return __( 'Site Copyright', 'bears' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'custom',
			[
				'label' => esc_html__( 'Custom Copyright', 'bears' ),
	...
	protected function register_layout_section_controls() {
		...
		$this->add_responsive_control(
			'text_align',
			[
				'label' => esc_html__( 'Alignment', 'bears' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'bears' ),
						'icon' => 'eicon-text-align-left',
					],
					'center' => [
						'title' => esc_html__( 'Center', 'bears' ),
						'icon' => 'eicon-text-align-center',
					],
					'right' => [
						'title' => esc_html__( 'Right', 'bears' ),
