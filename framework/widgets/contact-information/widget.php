<?php
namespace BearsElementorWidgets\Widgets\ContactInformation;
...
class Widget_ContactInformation extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact Infomation', 'bears' );
	}
	...
	protected function register_content_section_controls() {
		...
		$this->add_control(
			'heading',
			[
				'label' => esc_html__( 'Heading', 'bears' ),
		...
		$this->add_control(
			'description',
			[
				'label' => esc_html__( 'Description', 'bears' ),
		...
		$this->add_control(
			'button_text',
			[
				'label' => esc_html__( 'Button Text', 'bears' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => '',
			]
		...
		$this->add_control(
			'button_url',
			[
				'label' => esc_html__( 'Button Url', 'bears' ),
	...
	protected function register_style_content_section_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Heading Typography', 'bears' ),
				'default' => '',
		...
		$this->add_control(
			'description_color',
			[
				'label' => __( 'Description Color', 'bears' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Description Typography', 'bears' ),
				'default' => '',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Button Typography', 'bears' ),
				'default' => '',
