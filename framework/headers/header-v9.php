<?php 
	...
	$container_class = (isset($bears_options['h9_fullwidth'])&&$bears_options['h9_fullwidth'])?'fullwidth':'container';
	if(isset($page_options['header_fullwidth'])&&$page_options['header_fullwidth']){ $container_class = 'container'; }
	
	$header_class = 'bt-header bt-header-v9';
	
	if(isset($bears_options['h9_header_bottom_absolute'])&&$bears_options['h9_header_bottom_absolute']){
		$header_class .= ' bt-absolute';
	}
	
	$menu_assign = isset($bears_options['h9_menu_assign'])&&($bears_options['h9_menu_assign'] != 'auto')?$bears_options['h9_menu_assign']:'';
	...
	$header_stick = (isset($bears_options['h9_header_stick'])&&$bears_options['h9_header_stick'])?$bears_options['h9_header_stick']:'';
			...
			<div class="bt-subheader-inner <?php echo esc_attr($container_class); ?>">
				<div class="bt-subheader-cell bt-left">
					<div class="bt-content text-left">
						<?php
							$logo = isset($bears_options['h9_logo']['url'])?$bears_options['h9_logo']['url']:'';
							if(isset($page_options['header_logo']['url'])&&$page_options['header_logo']['url']){
								$logo = $page_options['header_logo']['url'];
							}
							
							$logo_height = (isset($bears_options['h9_logo_height'])&&$bears_options['h9_logo_height'])?$bears_options['h9_logo_height']:'40';
							...
							if(isset($bears_options['h9_menu_align'])&&$bears_options['h9_menu_align']=='left') {
				...
				<div class="bt-subheader-cell bt-center">
					<div class="bt-content text-center">
						<?php
							if(isset($bears_options['h9_menu_align'])&&$bears_options['h9_menu_align']=='center') {
								bears_nav_menu($menu_assign, 'main_navigation', 'bt-menu-desktop text-left');
							}
						?>
					</div>
				...
				<div class="bt-subheader-cell bt-right">
					<div class="bt-content text-right">
						<?php
							if(isset($bears_options['h9_menu_align'])&&$bears_options['h9_menu_align']=='right'||!isset($bears_options['h9_menu_align'])) {
								bears_nav_menu($menu_assign, 'main_navigation', 'bt-menu-desktop text-left');
							}
							
							if(isset($bears_options['h9_menu_content_right'])&&$bears_options['h9_menu_content_right']&&isset($bears_options['h9_menu_content_right_element'])&&$bears_options['h9_menu_content_right_element']){
								echo '<div class="bt-menu-content-right">';
									foreach($bears_options['h9_menu_content_right_element'] as $sidebar_id){
										dynamic_sidebar( $sidebar_id );
									}
								echo '</div>';
							}
							
							if(isset($bears_options['h9_menu_canvas'])&&$bears_options['h9_menu_canvas']){
		...
		<div class="bt-subheader">
			<div class="bt-subheader-inner <?php echo esc_attr($container_class); ?>">
				<div class="bt-subheader-cell bt-left">
					<div class="bt-content text-left">
						<?php
							$logo_stick = isset($bears_options['h9_logo_stick']['url'])?$bears_options['h9_logo_stick']['url']:'';
							...
							$logo_stick_height = isset($bears_options['h9_logo_stick_height'])?$bears_options['h9_logo_stick_height']:'30';
				...
				<div class="bt-subheader-cell bt-right">
					<div class="bt-content text-right">
						<?php
							if(isset($bears_options['h9_menu_align'])&&$bears_options['h9_menu_align']=='right') {
								bears_nav_menu($menu_assign, 'main_navigation', 'bt-menu-desktop text-left');
							}
		...
		<div class="bt-subheader bt-bottom">
			<div class="bt-subheader-inner container">
				<div class="bt-subheader-cell bt-left">
					<div class="bt-content text-left">
						<?php
							$logo_mobile = isset($bears_options['h9_logo_mobile']['url'])?$bears_options['h9_logo_mobile']['url']:'';
							if(isset($page_options['logo_mobile']['url'])&&$page_options['logo_mobile']['url']){
								$logo_mobile = $page_options['logo_mobile']['url'];
							}
							
							$logo_mobile_height = isset($bears_options['h9_logo_mobile_height'])?$bears_options['h9_logo_mobile_height']:'30';
