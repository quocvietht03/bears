...
$fullwidth = isset($bears_options['single_portolio_fullwidth'])&&$bears_options['single_portolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($bears_options['single_portolio_sidebar_width']) ?  $bears_options['single_portolio_sidebar_width']: 3;
$related_post = isset($bears_options['single_portfolio_related_post']) ? $bears_options['single_portfolio_related_post']: true;
$related_post_label = isset($bears_options['single_portfolio_related_post_label'])&&$bears_options['single_portfolio_related_post_label'] ? $bears_options['single_portfolio_related_post_label']: esc_html__('Portfolio Related', 'bears');
$related_post_count = (int) isset($bears_options['single_portfolio_related_post_count'])&&$bears_options['single_portfolio_related_post_count'] ? $bears_options['single_portfolio_related_post_count']: 3;
$related_post_per_row = (int) isset($bears_options['single_portfolio_related_post_per_row'])&&$bears_options['single_portfolio_related_post_per_row'] ? $bears_options['single_portfolio_related_post_per_row']: 3;
...
$single_portfolio_titlebar = isset($bears_options['single_portfolio_titlebar']) ? $bears_options['single_portfolio_titlebar']: true;
if($single_portfolio_titlebar) bears_titlebar();
?>
