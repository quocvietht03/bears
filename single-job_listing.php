...
$fullwidth = isset($bears_options['job_fullwidth'])&&$bears_options['job_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($bears_options['job_sidebar_width']) ?  $bears_options['job_sidebar_width']: 3;
...
$post_titlebar = isset($bears_options['job_titlebar']) ? $bears_options['job_titlebar']: true;
