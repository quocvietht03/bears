...
$fullwidth = isset($bears_options['portfolio_fullwidth'])&&$bears_options['portfolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($bears_options['portfolio_sidebar_width']) ?  $bears_options['portfolio_sidebar_width']: 3;
...
$portfolio_titlebar = isset($bears_options['portfolio_titlebar']) ? $bears_options['portfolio_titlebar']: true;
if($portfolio_titlebar) bears_titlebar();
?>
