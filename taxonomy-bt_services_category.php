...
$fullwidth = isset($bears_options['services_fullwidth'])&&$bears_options['services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($bears_options['services_sidebar_width']) ?  $bears_options['services_sidebar_width']: 3;
...
$services_titlebar = isset($bears_options['services_titlebar']) ? $bears_options['services_titlebar']: true;
if($services_titlebar) bears_titlebar();
?>
