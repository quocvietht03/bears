...
$fullwidth = isset($bears_options['shop_fullwidth'])&&$bears_options['shop_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($bears_options['shop_sidebar_width']) ? $bears_options['shop_sidebar_width']: 3;
$shop_top_bar = isset($bears_options['shop_top_bar']) ? $bears_options['shop_top_bar']: false;
$shop_product_per_row = (int) isset($bears_options['shop_product_per_row']) ? $bears_options['shop_product_per_row']: 3;
