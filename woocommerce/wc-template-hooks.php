...
add_filter( 'loop_shop_per_page', 'bears_loop_shop_per_page', 20 );
function bears_loop_shop_per_page( $cols ) {
	global $bears_options;
	$cols = (int) isset($bears_options['shop_product_per_page']) ? $bears_options['shop_product_per_page']: 10;
	return $cols;
}
