...
$fullwidth = isset($bears_options['single_services_fullwidth'])&&$bears_options['single_services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($bears_options['single_services_sidebar_width']) ?  $bears_options['single_services_sidebar_width']: 3;
...
$single_services_titlebar = isset($bears_options['single_services_titlebar']) ? $bears_options['single_services_titlebar']: true;
if($single_services_titlebar) bears_titlebar();
?>
