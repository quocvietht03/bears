...
<?php do_action( 'bears/import_pack/demo_install_package/before' ); ?>
...
<div class="ip-package-demo-list">
    ...
    <div class="ip-package-demo-item">
        <div class="preview-image">
            ...
            <div class="actions">
                <a href="<?php echo esc_url( $package_item['url_demo'] ) ?>" target="_blank" class="__action-preview-demo" title="<?php echo esc_attr( 'Preview demo', 'bears' ); ?>">
                    <?php _e( 'Preview', 'bears' ); ?>
                </a>
                <a href="javascript:" class="__action-import-demo" title="<?php echo esc_attr( 'Import demo', 'bears' ); ?>" data-package-id="<?php echo esc_attr( trim( $package_item['package_name'] ) ); ?>">
                    <?php _e( 'Import', 'bears' ); ?>
                </a>
            </div>
        </div>
...
<?php do_action( 'bears/import_pack/demo_install_package/after' ); ?>
