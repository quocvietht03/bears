...
if( ! function_exists( 'bears_import_pack_scripts' ) ) {
    /**
     * Import pack load scripts
     *
     */
    function bears_import_pack_scripts() {
        ...
        wp_localize_script( 'import-pack-js', 'import_pack_php_data', apply_filters( 'bears/import_pack/localize_script_data', [
            'ajax_url' => admin_url( 'admin-ajax.php' ),
        ] ) );
    }

    add_action( 'admin_enqueue_scripts', 'bears_import_pack_scripts' );
}
