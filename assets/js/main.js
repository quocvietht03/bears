!(function($){
  ...
  /* Toggle sub menu mobile */
	function BearsToggleSubMenuMobile() {
	...
	function BearsCopyrightCurrentYear() {
		var searchTerm = '{Year}',
