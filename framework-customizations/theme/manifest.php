...
$manifest['id']                  = 'bears';
$manifest['skin']                = 'main';
$manifest['name']                = esc_html__( 'Bearsthemes', 'bears' );
$manifest['uri']                 = 'http://theme.bearsthemes.com/wordpress/bears-demo/';
$manifest['description']         = esc_html__( 'WordPress Theme', 'bears' );
