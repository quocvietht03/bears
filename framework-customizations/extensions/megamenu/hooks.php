...
if(!function_exists('bears_menu_item_dynamic_sidebar')) {
	function bears_menu_item_dynamic_sidebar( $content = '', $item ) {
		// extra options
		$extra_options = array();
		$sidebar_content = '';
...
add_filter( 'walker_nav_menu_start_el_custom', 'bears_menu_item_dynamic_sidebar', 10, 2 );
