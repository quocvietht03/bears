...
$fullwidth = isset($bears_options['single_team_fullwidth'])&&$bears_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($bears_options['single_team_sidebar_width']) ?  $bears_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($bears_options['single_team_titlebar']) ? $bears_options['single_team_titlebar']: true;
if($single_team_titlebar) bears_titlebar();
?>
